...
public class Elipsa extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elipsa);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(stA.equals("")||stB.equals("")){
                    ...
                    {
                        plusY=Math.pow(a*b,2)-Math.pow(b*x,2)/Math.pow(a,2);
                        minusY=-plusY;
                        series1.appendData(new DataPoint(x,plusY),true,GRAPHSIZE);
                        series2.appendData(new DataPoint(x,minusY),true,GRAPHSIZE);
                        x=x+0.1;
                    }
